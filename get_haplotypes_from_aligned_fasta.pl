...
my $start_position = 1; # Ignore positions to the left of this in the genome alignment
my $end_position = 29903; # Ignore positions to the right of this in the genome alignment
...
foreach my $only_include_outbreak_samples (0,1) { 
    ...
    my $id2pseudoseq_ref = get_pseudosequences(\%id2seq, $exclude_ambiguous_sites, \%excluded_positions, \%variant_positions);
    ...
    write_pseudosequences_nexus_file($nexus_file, \%id2pseudoseq, \%trait_to_ids);
...
sub write_pseudosequences_nexus_file {
    ...
    my $number_of_traits = scalar(@traits) + 1;
    ...
    print PSEUDOSEQ "TraitLabels @traits Other;\n";
    print PSEUDOSEQ "Matrix\n";
